...
class FileCompressor {
    //при вход - валиден path към файл, да извлича информацията от него под формата на текст
    //да използва някой инструмент за кодиране на текст към двоичен вектор
    //да записва в бинарен файл двоичния вектор
};
